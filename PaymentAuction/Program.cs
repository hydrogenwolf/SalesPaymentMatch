...
/*
CREATE TABLE [dbo].[PaymentAuction](
 ...
 CONSTRAINT [PK_PaymentAuction] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
...
ALTER TABLE [dbo].[PaymentAuction] ADD  CONSTRAINT [DF_PaymentAuction_RegistrationDate]  DEFAULT (getdate()) FOR [RegistrationDate]
GO

CREATE INDEX [IX_PaymentAuction_InvoiceNumber] ON [PaymentAuction] ([송장번호])
GO
 */
...
namespace Auction
{
    class Program
    {
        ...
        static string tableName = "PaymentAuction";
